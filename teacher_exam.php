...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="margin-top: 1vh;">
        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-sm text-gray-900 uppercase bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-5" onclick="openPopup()" style="float: right">
        ...
        <tbody>
            <tr class="bg-gray-50 border-b ">
                ...
                <td class="px-6 py-4 text-center">
                    <a href="/examm/questions.html" id="open-modal" class="font-medium text-blue-600">Edit</a>
...
content.innerHTML = '<form method="post" action="teacher_submit_popup.php">' +
                    ...
                    '<label for="name">Total Questions:</label>' +
