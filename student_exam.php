...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="margin-top: 1vh;">
        ...
        <tbody>
            <tr class="bg-gray-50 border-b ">
                ...
                <th scope="row" class="px-6 py-4 font-medium text-blue-600 whitespace-nowrap text-center">
                    <a href="/examm/timetable.pdf" target="_blank" style="text-decoration: underline;">View</a>
                </th>
                <td class="px-6 py-4 text-center">
                  <a href="/examm/exam.php" style="text-decoration: underline;">Give Test</a>
                </td>
            </tr>
