...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="margin-top: 1vh;">
        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-sm text-gray-900 uppercase bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-5 pop" id="open-modal" onclick="openPopup()" style="float: right">
    ...
    <p class="py-2 px-3 text-gray-400 bg-gray-50" style="font-size:x-small">Showing <?php echo $count; ?> of <?php echo $count; ?> Entries</p>
</div>
...
content.innerHTML = '<form method="post" action="admin_subject_add.php">' +
